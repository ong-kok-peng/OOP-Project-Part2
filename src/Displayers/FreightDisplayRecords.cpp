...
#include "FreightDisplayRecords.h"

FreightDisplayRecords::FreightDisplayRecords(IReadFreightRecords& readFR) : readFR{ readFR } {}

void FreightDisplayRecords::displayRecords() {
